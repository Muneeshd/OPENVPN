...
read -p "OpenVPN protocol: " openvpn_proto
...
read -p "MySQL user name for OpenVPN-Admin: " mysql_user
...
read -p "Root certificate expiration: " ca_expire

read -p "Certificate expiration: " cert_expire

read -p "Country Name ie 2 letter code: " cert_country

read -p "State or Province Name : " cert_province

read -p "Locality Name or city name: " cert_city

read -p "Organization Name or company name: " cert_org

read -p "Organizational Unit Name eg IT or Ecommerce: " cert_ou

read -p "Email Address: " cert_email

read -p "Common Name or server hostname or domain name: " key_cn
